...
* [LosslessCut](https://github.com/mifi/lossless-cut) ⭐ 39,088 | 🐛 241 | 🌐 TypeScript | 📅 2026-03-14 - The swiss army knife of lossless video/audio editing without re-encoding.
...
* [MPV](https://github.com/mpv-player/mpv) ⭐ 34,452 | 🐛 1,106 | 🌐 C | 📅 2026-03-15 - Lightweight, highly configurable media player.
...
* [MonitorControl](https://github.com/MonitorControl/MonitorControl) ⭐ 32,690 | 🐛 18 | 🌐 Swift | 📅 2026-02-09 - Control your external monitor brightness, contrast or volume directly from a menulet or with keyboard native keys.
...
* [Background Music](https://github.com/kyleneideck/BackgroundMusic) ⭐ 18,748 | 🐛 523 | 🌐 C++ | 📅 2026-02-22 - Background Music, a macOS audio utility: automatically pause your music, set individual apps' volumes and record system audio.
...
* [BlackHole](https://github.com/ExistentialAudio/BlackHole) ⭐ 18,575 | 🐛 9 | 🌐 C | 📅 2025-12-19 - BlackHole is a modern macOS virtual audio driver that allows applications to pass audio to other applications with zero additional latency.
...
* [Audacity](https://github.com/audacity/audacity) ⭐ 16,645 | 🐛 1,498 | 🌐 C++ | 📅 2026-03-16 - Free, open source, cross-platform audio software
...
* [shairport-sync](https://github.com/mikebrady/shairport-sync) ⭐ 8,544 | 🐛 11 | 🌐 C | 📅 2026-03-11 - macOS/Linux/FreeBSD/OpenBSD Airplay audio receiver.
...
* [eqMac2](https://github.com/bitgapp/eqMac) ⭐ 6,537 | 🐛 130 | 🌐 Swift | 📅 2025-11-02 - System-Wide Equalizer for the Mac.
...
* [LyricsX](https://github.com/ddddxxx/LyricsX) ⭐ 5,126 | 🐛 307 | 🌐 Swift | 📅 2025-09-29 - Lyrics for iTunes, Spotify and Vox.
...
* [Clementine](https://github.com/clementine-player/Clementine) ⭐ 4,177 | 🐛 2,436 | 🌐 C++ | 📅 2026-02-18 - Clementine is a modern music player and library organizer for Windows, Linux and macOS.
...
* [SpotMenu](https://github.com/kmikiy/SpotMenu) ⭐ 3,077 | 🐛 14 | 🌐 Swift | 📅 2026-03-12 - Spotify and iTunes in your menu bar.
...
* [fre:ac](https://github.com/enzo1982/freac) ⭐ 1,795 | 🐛 207 | 🌐 C++ | 📅 2026-03-07 - The fre:ac audio converter project.
...
* [Tickeys](https://github.com/yingDev/Tickeys) ⭐ 1,531 | 🐛 51 | 🌐 Rust | 📅 2023-04-23 - Instant audio feedback for typing. macOS version.
...
* [StargateDAW](https://github.com/stargatedaw/stargate) ⭐ 818 | 🐛 18 | 🌐 Python | 📅 2025-04-21 - An all-in-one digital audio workstation (DAW) and plugin suite
...
* [Karaoke Forever](https://github.com/bhj/KaraokeEternal) ⭐ 776 | 🐛 7 | 🌐 TypeScript | 📅 2026-02-14 - Host awesome karaoke parties where everyone can queue songs from their phone's browser. Plays MP3+G and MP4 with WebGL visualizations.
...
* [jmc](https://github.com/jcm93/jmc) ⭐ 517 | 🐛 19 | 🌐 Swift | 📅 2022-08-23 - jmc is new macOS media organizer.
...
* [AutoMute](https://github.com/yonilevy/automute) ⭐ 280 | 🐛 4 | 🌐 Objective-C | 📅 2024-03-26 - Automatically mute the sound when headphones disconnect / Mac awake from sleep.
...
* [Plug](https://github.com/wulkano/Plug) ⭐ 228 | 🐛 14 | 🌐 Swift | 📅 2024-02-20 - Discover and listen to music from Hype Machine.
...
* [waveSDR](https://github.com/getoffmyhack/waveSDR) ⭐ 228 | 🐛 0 | 🌐 Swift | 📅 2020-03-03 - macOS native desktop Software Defined Radio application using the RTL-SDR USB device.
...
* [Suohai](https://github.com/Sunnyyoung/Suohai) ⭐ 138 | 🐛 1 | 🌐 Swift | 📅 2019-04-30 - Audio input/output source lock for macOS.
...
* [Pulp](https://github.com/bazalp/pulp) ⭐ 83 | 🐛 11 | 🌐 TypeScript | 📅 2025-10-27 - Audio Sample manager.
...
* [LyricGlow](https://github.com/ateymoori/lyricglow) ⭐ 15 | 🐛 2 | 🌐 TypeScript | 📅 2026-02-05 - macOS application displaying synchronized lyrics with animated word-by-word glow effects for Spotify, Apple Music, and YouTube Music.
...
* [Mackup](https://github.com/lra/mackup) ⭐ 15,133 | 🐛 294 | 🌐 Python | 📅 2026-03-10 - Keep your application settings in sync (macOS/Linux).
...
* [shallow-backup](https://github.com/alichtman/shallow-backup) ⭐ 1,313 | 🐛 32 | 🌐 Python | 📅 2025-02-13 - Easily create lightweight documentation of installed applications, dotfiles, and more.
...
* [UrBackup](https://github.com/uroni/urbackup_backend) ⭐ 843 | 🐛 1 | 🌐 C | 📅 2026-03-05 - UrBackup is Client/Server network backup for Windows, macOS and Linux.
...
* [Syncalicious](https://github.com/zenangst/Syncalicious) ⭐ 434 | 🐛 11 | 🌐 Swift | 📅 2019-12-20 - Keeping multiple macOS preferences in sync can be painful, but it shouldn't be.
...
* [Brave Browser](https://github.com/brave/brave-browser) ⭐ 21,942 | 🐛 9,873 | 📅 2026-03-17 - Brave browser for Desktop and Laptop computers running Windows, macOS, and Linux.
...
* [Min Browser](https://github.com/minbrowser/min) ⭐ 8,892 | 🐛 595 | 🌐 JavaScript | 📅 2026-03-01 - A fast and efficient minimal web browser.
...
* [Finicky](https://github.com/johnste/finicky) ⭐ 4,656 | 🐛 35 | 🌐 Go | 📅 2026-03-16 - Always opens the right browser.
...
* [Plash](https://github.com/sindresorhus/Plash) ⭐ 3,931 | 🐛 35 | 📅 2025-10-29 - Make any website your desktop wallpaper.
...
* [Pennywise](https://github.com/kamranahmedse/pennywise) ⭐ 3,859 | 🐛 56 | 🌐 JavaScript | 📅 2025-12-22 - Pennywise opens any website or media in a small floating window that remains on top of all other applications. It's a great alternative to Helium.
...
* [otter-browser](https://github.com/OtterBrowser/otter-browser) ⭐ 1,956 | 🐛 269 | 🌐 C++ | 📅 2026-03-16 - Otter Browser aims to recreate the best aspects of the classic Opera (12.x) UI using Qt5.
...
* [seb-mac](https://github.com/SafeExamBrowser/seb-mac) ⭐ 122 | 🐛 84 | 🌐 C | 📅 2026-03-13 - Safe Exam Browser for macOS and iOS.
...
* [Telegram Desktop](https://github.com/telegramdesktop/tdesktop) ⭐ 30,209 | 🐛 946 | 🌐 C++ | 📅 2026-03-16 - Telegram Desktop messaging app.
...
* [Signal Desktop](https://github.com/signalapp/Signal-Desktop) ⭐ 16,128 | 🐛 891 | 🌐 TypeScript | 📅 2026-03-16 - Electron app that links with your Signal Android or Signal iOS app.
...
* [Element](https://github.com/vector-im/element-web) ⭐ 12,838 | 🐛 3,627 | 🌐 TypeScript | 📅 2026-03-17 - Element is a collaboration app (currently Electron) for the [Matrix](https://matrix.org/) protocol.
...
* [Telegram](https://github.com/overtake/TelegramSwift) ⭐ 5,597 | 🐛 879 | 🌐 Swift | 📅 2025-09-22 - Source code of Telegram for macOS on Swift.
...
* [Franz](https://github.com/meetfranz/franz) ⭐ 4,676 | 🐛 388 | 🌐 JavaScript | 📅 2025-09-24 - Franz is messaging application for services like WhatsApp, Slack, Messenger and many more.
...
* [Swiftcord](https://github.com/SwiftcordApp/Swiftcord) ⭐ 2,194 | 🐛 28 | 🌐 Swift | 📅 2024-05-29 - Native Discord client built in Swift & SwiftUI. Light on your RAM and CPU.
...
* [ChitChat](https://github.com/stonesam92/ChitChat) ⭐ 1,895 | 🐛 71 | 🌐 Objective-C | 📅 2019-10-07 - Native Mac app wrapper for WhatsApp Web.
...
* [RocketChat](https://github.com/RocketChat/Rocket.Chat.Electron) ⭐ 1,678 | 🐛 251 | 🌐 TypeScript | 📅 2026-03-16 - Free open source chat system for teams. An alternative to Slack that can also be self hosted.
...
* [Wire Desktop](https://github.com/wireapp/wire-desktop) ⭐ 1,118 | 🐛 216 | 🌐 TypeScript | 📅 2026-03-17 - Standalone Electron app for the chatapp Wire.
...
* [Adium](https://github.com/adium/adium) ⭐ 363 | 🐛 31 | 🌐 Objective-C | 📅 2021-10-20 - Instant messaging application that can connect to XMPP (Jabber), IRC and more.
...
* [Beagle IM](https://github.com/tigase/beagle-im) ⭐ 204 | 🐛 72 | 🌐 Swift | 📅 2026-03-15 - Powerful XMPP client with support for file transfer, VoIP and end-to-end encryption.
...
* [Bitcoin Core](https://github.com/bitcoin/bitcoin) ⭐ 88,514 | 🐛 686 | 🌐 C++ | 📅 2026-03-17 - Official Bitcoin Core software for running a full Bitcoin node.
...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 49,139 | 🐛 3,229 | 🌐 Java | 📅 2026-03-16 - Universal database tool and SQL client.
...
* [DB Browser for SQLite](https://github.com/sqlitebrowser/sqlitebrowser) ⭐ 23,777 | 🐛 827 | 🌐 C++ | 📅 2026-03-04 - SQLite database management GUI.
...
* [Redis Desktop Manager](https://github.com/uglide/RedisDesktopManager) ⭐ 23,227 | 🐛 67 | 🌐 C++ | 📅 2024-07-10 - Cross-platform open source database management tool for Redis ®
...
* [Beekeeper Studio](https://github.com/beekeeper-studio/beekeeper-studio) ⭐ 22,213 | 🐛 1,050 | 🌐 TypeScript | 📅 2026-03-17 - SQL editor and manager with support for SQLite, MySQL, MariaDB, Postgres, CockroachDB, SQL Server, and Amazon Redshift.
...
* [Medis](https://github.com/luin/medis) ⭐ 11,772 | 🐛 72 | 🌐 JavaScript | 📅 2024-02-21 - 💻 Medis is a beautiful, easy-to-use Mac database management application for Redis.
...
* [Sequel Pro](https://github.com/sequelpro/sequelpro) ⭐ 9,195 | 🐛 529 | 🌐 Objective-C | 📅 2023-02-25 - MySQL/MariaDB database management for macOS.
...
* [Postgres.app](https://github.com/PostgresApp/PostgresApp) ⭐ 7,708 | 🐛 146 | 🌐 Makefile | 📅 2026-03-12 - The easiest way to get started with PostgreSQL on the Mac.
...
* [Sequel Ace](https://github.com/Sequel-Ace/Sequel-Ace) ⭐ 7,330 | 🐛 195 | 🌐 Objective-C | 📅 2026-03-16 - Sequel Ace is a fast, easy-to-use Mac database management application for working with MySQL & MariaDB databases.
...
* [DbGate](https://github.com/dbgate/dbgate) ⭐ 6,830 | 🐛 451 | 🌐 Svelte | 📅 2026-03-16 - Database manager for MySQL, PostgreSQL, SQL Server, MongoDB, SQLite and others. Runs under Windows, Linux, Mac or as web application.
...
* [sqlectron](https://github.com/sqlectron/sqlectron-gui) ⭐ 4,734 | 🐛 145 | 🌐 TypeScript | 📅 2025-12-03 - A simple and lightweight SQL client desktop/terminal with cross database and platform support.
...
* [MongoHub](https://github.com/jeromelebel/MongoHub-Mac) ⭐ 2,420 | 🐛 87 | 🌐 Objective-C | 📅 2021-05-04 - Add another lightweight Mac Native MongoDB client.
...
* [Bdash](https://github.com/bdash-app/bdash) ⭐ 1,514 | 🐛 24 | 🌐 TypeScript | 📅 2026-03-11 - Simple SQL Client for lightweight data analysis.
...
* [mongoDB.app](https://github.com/gcollazo/mongodbapp) ⭐ 535 | 🐛 2 | 🌐 Objective-C | 📅 2025-02-24 - The easiest way to get started with mongoDB on the Mac.
...
* [Clipboard](https://github.com/Slackadays/Clipboard) ⭐ 5,710 | 🐛 22 | 🌐 C++ | 📅 2025-06-11 - An easy-to-use clipboard manager with time saving features that work across all terminals.
...
* [Apache Netbeans](https://github.com/apache/netbeans) ⭐ 3,028 | 🐛 1,065 | 🌐 Java | 📅 2026-03-16 - Apache NetBeans is an IDE, Tooling Platform and Application Framework suitable for development in Java, JavaScript, PHP, HTML5, CSS, and more.
...
* [LocationSimulator](https://github.com/Schlaubischlump/LocationSimulator) ⭐ 2,923 | 🐛 27 | 🌐 Swift | 📅 2024-10-30 - Application to spoof your iOS or iPhoneSimulator location.
...
* [GitAhead](https://github.com/gitahead/gitahead/) ⭐ 1,920 | 🐛 292 | 🌐 C++ | 📅 2025-09-15 - A graphical Git client designed to help you understand and manage your source code history.
...
* [Brackets](https://github.com/brackets-cont/brackets) ⭐ 1,499 | 🐛 75 | 🌐 JavaScript | 📅 2024-12-13 - Modern open-source code editor for HTML, CSS and JavaScript that's built in HTML, CSS and JavaScript.
...
* [ColorSet](https://github.com/DigiDNA/ColorSet) ⭐ 237 | 🐛 0 | 🌐 Swift | 📅 2026-01-19 - ColorSet is a macOS utility and framework allowing developers to manage custom interface colors with ease.
...
* [Eclipse](https://github.com/eclipse-platform/eclipse.platform) ⭐ 147 | 🐛 293 | 🌐 Java | 📅 2026-03-17 - Eclipse is an open-source integrated development environment (IDE) used in computer programming, featuring a base workspace and an extensible plug-in system for customizing the environment.
...
* [M-Courtyard](https://github.com/Mcourtyard/m-courtyard) ⭐ 69 | 🐛 1 | 🌐 TypeScript | 📅 2026-03-11 - Desktop app for fine-tuning LLMs on Apple Silicon Macs with zero code. Import documents, generate training datasets with AI, LoRA fine-tune, test, and export to Ollama — entirely offline.
  ...
  **Website:** <https://github.com/Mcourtyard/m-courtyard> ⭐ 69 | 🐛 1 | 🌐 TypeScript | 📅 2026-03-11
...
* [Gridfy](https://github.com/Slllava/gridfy) ⭐ 36 | 🐛 0 | 🌐 Swift | 📅 2025-05-09 - Quickly calculate column widths and get correct results for your grid.
...
* [GitHub Desktop](https://github.com/desktop/desktop) ⭐ 21,274 | 🐛 976 | 🌐 TypeScript | 📅 2026-03-16 - Simple collaboration from your desktop.
...
* [GitUp](https://github.com/git-up/GitUp) ⭐ 11,955 | 🐛 372 | 🌐 Objective-C | 📅 2026-02-15 - The Git interface you've been missing all your life has finally arrived.
...
* [Gitify](https://github.com/manosim/gitify) ⭐ 5,206 | 🐛 17 | 🌐 TypeScript | 📅 2026-03-16 - Your GitHub notifications on your menu bar.
...
* [Git Interactive Rebase Tool](https://github.com/MitMaro/git-interactive-rebase-tool) ⭐ 1,848 | 🐛 30 | 🌐 Rust | 📅 2026-02-04 - Full feature terminal based sequence editor for interactive rebase.
...
* [Trailer](https://github.com/ptsochantaris/trailer) ⭐ 1,205 | 🐛 17 | 🌐 Swift | 📅 2025-12-07 - Managing Pull Requests and Issues For GitHub & GitHub Enterprise.
...
* [Xit](https://github.com/Uncommon/Xit) ⭐ 1,155 | 🐛 138 | 🌐 Swift | 📅 2026-03-14 - Xit is a graphical tool for working with git repositories.
...
* [GitX](https://github.com/gitx/gitx) ⭐ 882 | 🐛 77 | 🌐 Objective-C | 📅 2026-03-16 - Graphical client for the git version control system.
...
* [Tempo](https://github.com/maoyama/Tempo) ⭐ 195 | 🐛 12 | 🌐 Swift | 📅 2026-02-23 - Replace the Git CLI with a clear UI and AI assist.
...
* [JSONExport](https://github.com/Ahmed-Ali/JSONExport) ⭐ 4,823 | 🐛 54 | 🌐 Swift | 📅 2023-10-22 - Desktop application for macOS which enables you to export JSON objects as model classes with their associated constructors, utility methods, setters and getters in your favorite language.
...
* [j2s](https://github.com/zadr/j2s) ⭐ 232 | 🐛 5 | 🌐 Swift | 📅 2026-01-04 - macOS app to convert JSON objects into Swift structs (currently targets Swift 4 and Codable).
...
* [JSON to Model class](https://github.com/chanonly123/Json-Model-Generator) ⭐ 98 | 🐛 0 | 🌐 Swift | 📅 2021-12-10 - Template based highly customizable macOS app to generate classes from JSON string, supports many languages.
...
* [MQTTX](https://github.com/emqx/MQTTX) ⭐ 4,830 | 🐛 95 | 🌐 TypeScript | 📅 2026-02-03 - An elegant Cross-platform MQTT 5.0 desktop client.
...
* [Boop](https://github.com/IvanMathy/Boop) ⭐ 4,112 | 🐛 196 | 🌐 JavaScript | 📅 2024-06-30 - A scriptable scratchpad for developers.
...
* [macho-browser](https://github.com/dcsch/macho-browser) ⭐ 128 | 🐛 2 | 🌐 Objective-C | 📅 2021-01-26 - Browser for macOS Mach-O binaries.
...
* [Insomnia](https://github.com/Kong/insomnia) ⭐ 38,076 | 🐛 816 | 🌐 TypeScript | 📅 2026-03-17 - Insomnia is a cross-platform REST client, built on top of Electron.
...
* [Requestly](https://github.com/requestly/requestly) ⭐ 6,521 | 🐛 337 | 🌐 TypeScript | 📅 2026-03-17 - A lightweight open-source API Development, Testing & Mocking platform
...
* [HTTP Toolkit](https://github.com/httptoolkit/httptoolkit-desktop) ⭐ 699 | 🐛 15 | 🌐 TypeScript | 📅 2026-03-16 - HTTP Toolkit is a cross-platform tool to intercept, debug & mock HTTP.
...
* [stts](https://github.com/inket/stts) ⭐ 559 | 🐛 14 | 🌐 Swift | 📅 2026-03-17 - macOS app for monitoring the status of cloud services.
...
* [Corectl App for macOS](https://github.com/TheNewNormal/corectl.app) ⭐ 167 | 🐛 3 | 🌐 Swift | 📅 2017-09-18 - Corectl App is a macOS Status bar App which works like a wrapper around the corectl command line tool corectld to control the server runtime process.
...
* [Xcodes.app](https://github.com/RobotsAndPencils/XcodesApp) ⭐ 8,300 | 🐛 201 | 🌐 Swift | 📅 2025-09-20 - The easiest way to install and switch between multiple versions of Xcode.
...
* [Knuff](https://github.com/KnuffApp/Knuff) ⭐ 5,235 | 🐛 21 | 🌐 Objective-C | 📅 2022-09-04 - The debug application for Apple Push Notification Service (APNs).
...
* [InjectionIII](https://github.com/johnno1962/InjectionIII) ⭐ 4,590 | 🐛 4 | 🌐 Objective-C | 📅 2026-03-03 - overdue Swift rewrite of Injection.
...
* [Input Source Pro](https://github.com/runjuu/InputSourcePro/) ⭐ 2,926 | 🐛 42 | 🌐 Swift | 📅 2026-01-31 - Input Source Pro is macOS utility designed for multilingual users who frequently switch input sources.
...
* [Asset Catalog Tinkerer](https://github.com/insidegui/AssetCatalogTinkerer) ⭐ 2,801 | 🐛 13 | 🌐 Swift | 📅 2025-08-26 - App that lets you open .car files and browse/extract their images.
...
* [SmartPush](https://github.com/shaojiankui/SmartPush) ⭐ 2,285 | 🐛 7 | 🌐 Objective-C | 📅 2024-02-19 - iOS Push Notification Debug App.
...
* [Localization Editor](https://github.com/igorkulman/iOSLocalizationEditor) ⭐ 1,489 | 🐛 3 | 🌐 Swift | 📅 2024-04-05 - Simple macOS editor app to help you manage iOS app localizations by allowing you to edit all the translations side by side.
...
* [IconGenerator](https://github.com/onmyway133/IconGenerator) ⭐ 1,429 | 🐛 23 | 🌐 JavaScript | 📅 2023-11-29 - macOS app to generate app icons.
...
* [Attabench](https://github.com/attaswift/Attabench) ⭐ 1,277 | 🐛 5 | 🌐 Swift | 📅 2022-02-23 - Attabench is a microbenchmarking app for macOS, designed to measure and visualize the performance of Swift code.
...
* [Iconizer](https://github.com/raphaelhanneken/iconizer) ⭐ 889 | 🐛 6 | 🌐 Swift | 📅 2023-05-23 - Create Xcode image catalogs (xcassets) on the fly.
...
* [Clendar](https://github.com/vinhnx/Clendar) ⭐ 704 | 🐛 78 | 🌐 Swift | 📅 2026-02-17 - Clendar is an universal calendar app. Written in SwiftUI.
...
* [AppBox](https://github.com/getappbox/AppBox-iOSAppsWirelessInstallation) ⭐ 687 | 🐛 1 | 🌐 Objective-C | 📅 2025-12-26 - Tool for iOS developers to build and deploy Development, Ad-Hoc and In-house (Enterprise) applications directly to the devices from your Dropbox account.
...
* [Icons.app](https://github.com/SAP/macos-icon-generator) ⭐ 583 | 🐛 0 | 🌐 C | 📅 2026-01-07 - App for macOS which is designed to generate consistent sized icons of an existing application in various states, jiggling (shaking) etc.
...
* [AppIcons](https://github.com/kuyawa/AppIcons) ⭐ 289 | 🐛 5 | 🌐 Swift | 📅 2022-07-13 - Tool for generating icons in all sizes as required by macOS and iOS apps.
...
* [FilterShop](https://github.com/KrisYu/FilterShop) ⭐ 99 | 🐛 2 | 🌐 Swift | 📅 2021-02-10 - macOS App to explore CoreImage Filters.
...
* [Resizr](https://github.com/onurgenes/Resizr) ⭐ 42 | 🐛 1 | 🌐 Swift | 📅 2019-12-12 - MacOS application for creating AppIcon for iOS and Android apps.
...
* [Motrix](https://github.com/agalwood/Motrix) ⭐ 51,048 | 🐛 773 | 🌐 JavaScript | 📅 2024-07-11 - A full-featured download manager.
...
* [Extream Download Manager](https://github.com/subhra74/xdm) ⭐ 7,644 | 🐛 844 | 🌐 C# | 📅 2024-01-23 - a powerful tool to increase download speeds up to 500%
...
* [Applite](https://github.com/milanvarady/Applite) ⭐ 6,531 | 🐛 18 | 🌐 Swift | 📅 2026-02-05 - User-friendly GUI app for Homebrew Casks. Install, update, and uninstall apps with a single click.
...
* [YouTube Downloader for macOS](https://github.com/DenBeke/YouTube-Downloader-for-macOS) ⭐ 594 | 🐛 5 | 🌐 Swift | 📅 2025-09-25 - Simple menu bar app to download YouTube movies on your Mac. I wrote this as a test project to learn more about app development on macOS.
...
* [App Downloader](https://github.com/yep/app-downloader) ⭐ 389 | 🐛 0 | 🌐 Swift | 📅 2026-01-16 - Easily search and download macOS apps from the huge `homebrew cask` app catalog.
...
* [Zed](https://github.com/zed-industries/zed) ⭐ 77,295 | 🐛 3,230 | 🌐 Rust | 📅 2026-03-17 - Zed is an open source, high-performance, and multiplayer code editor
...
* [CodeEdit](https://github.com/CodeEditApp/CodeEdit) ⭐ 22,706 | 🐛 197 | 🌐 Swift | 📅 2025-12-14 - CodeEdit App for macOS – Elevate your code editing experience. Open source, free forever.
...
* [Geany](https://github.com/geany/geany) ⭐ 3,558 | 🐛 1,189 | 🌐 C | 📅 2026-03-12 - Geany is a powerful, stable and lightweight programmer's text editor that provides tons of useful features without bogging down your workflow.
...
* [Chime](https://github.com/ChimeHQ/Chime) ⭐ 462 | 🐛 6 | 🌐 Swift | 📅 2025-12-14 - An editor for macOS
...
* [mxMarkEdit](https://github.com/maxnd/mxMarkEdit) ⭐ 20 | 🐛 0 | 🌐 Pascal | 📅 2025-09-02 - A visual editor of Markdown document, tasks and tables.

  **Languages:** <code>free-pascal</code>

  **Website:** <https://github.com/maxnd/mxMarkEdit> ⭐ 20 | 🐛 0 | 🌐 Pascal | 📅 2025-09-02
...
* [TableTool](https://github.com/jakob/TableTool) ⭐ 1,366 | 🐛 69 | 🌐 Objective-C | 📅 2020-04-15 - A simple CSV editor for macOS.
...
* [JSON-Splora](https://github.com/wellsjo/JSON-Splora) ⭐ 1,860 | 🐛 20 | 🌐 JavaScript | 📅 2017-02-22 - GUI for editing, visualizing, and manipulating JSON data.
...
* [JSON Editor](https://github.com/fand/json-editor-app) ⭐ 66 | 🐛 4 | 🌐 TypeScript | 📅 2021-06-14 - Dead simple JSON editor using josdejong/jsoneditor
...
* [Mark Text](https://github.com/marktext/marktext/) ⭐ 54,489 | 🐛 1,404 | 🌐 JavaScript | 📅 2026-03-04 - Realtime preview markdown editor for macOS Windows and Linux.
...
* [Obsidian plugins & themes](https://github.com/obsidianmd/obsidian-releases) ⭐ 15,541 | 🐛 1,602 | 📅 2026-03-17 - Community plugins list, theme list, and releases of Obsidian.
...
* [Zettlr](https://github.com/Zettlr/Zettlr) ⭐ 12,676 | 🐛 538 | 🌐 TypeScript | 📅 2026-03-17 - A Markdown Editor for the 21st century.
...
* [MacDown](https://github.com/MacDownApp/macdown) ⭐ 9,708 | 🐛 561 | 🌐 Rich Text Format | 📅 2023-07-10 - Markdown editor for macOS.
...
* [QOwnNotes](https://github.com/pbek/QOwnNotes) ⭐ 5,629 | 🐛 143 | 🌐 C++ | 📅 2026-03-16 - Plain-text file notepad and todo-list manager with markdown support and ownCloud / Nextcloud integration.
...
* [MarkEdit](https://github.com/MarkEdit-app/MarkEdit) ⭐ 3,874 | 🐛 7 | 🌐 Swift | 📅 2026-03-17 - MarkEdit is a free and open-source Markdown editor, for macOS. It's just like TextEdit on Mac but dedicated to Markdown.
...
* [Pine](https://github.com/lukakerr/Pine) ⭐ 3,467 | 🐛 45 | 🌐 Swift | 📅 2022-12-20 - A modern MacOS markdown editor.
...
* [linked](https://github.com/lostdesign/linked) ⭐ 989 | 🐛 13 | 🌐 JavaScript | 📅 2024-07-17 - 🧾 Your daily journal app, diary or anything else to unclutter your mind. Let linked help you get focused by writing down what is in your mind on a daily basis.
...
* [Notenik](https://github.com/hbowie/notenik-swift) ⭐ 107 | 🐛 1 | 🌐 Swift | 📅 2024-12-18 - Note-taking app with many organizational options.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 28,187 | 🐛 1,009 | 🌐 Go | 📅 2026-03-17 - A terminal-based text editor that aims to be easy to use and intuitive, while also taking advantage of the capabilities of modern terminals.
...
* [TextMate](https://github.com/textmate/textmate) ⭐ 14,745 | 🐛 20 | 🌐 Objective-C++ | 📅 2024-05-18 - TextMate is a graphical text editor for macOS.
...
* [Notesnook](https://github.com/streetwriters/notesnook) ⭐ 13,836 | 🐛 1,036 | 🌐 TypeScript | 📅 2026-03-17 - A fully open source and end-to-end encrypted note taking alternative to Evernote.
...
* [MacVim](https://github.com/macvim-dev/macvim) ⭐ 7,796 | 🐛 189 | 🌐 Vim Script | 📅 2026-03-02 - Text editor for macOS.
...
* [CotEditor](https://github.com/coteditor/CotEditor) ⭐ 7,710 | 🐛 20 | 🌐 Swift | 📅 2026-03-17 - Lightweight Plain-Text Editor for macOS.
...
* [VimR](https://github.com/qvacua/vimr) ⭐ 6,931 | 🐛 315 | 🌐 Swift | 📅 2026-01-29 - Refined Neovim experience for macOS.
...
* [SubEthaEdit](https://github.com/subethaedit/SubEthaEdit) ⭐ 1,419 | 🐛 90 | 🌐 Objective-C | 📅 2025-11-09 - General purpose plain text editor for macOS. Widely known for its live collaboration feature.
...
* [Middleclick](https://github.com/artginzburg/MiddleClick-Ventura) ⭐ 2,496 | 🐛 35 | 🌐 Swift | 📅 2025-12-03 - Emulate a scroll wheel click with three finger Click or Tap on MacBook trackpad and Magic Mouse
...
* [Swimat](https://github.com/Jintin/Swimat) ⭐ 1,638 | 🐛 24 | 🌐 Swift | 📅 2022-11-18 - Swimat is an Xcode plug-in to format your Swift code.
...
* [AdGuard for Safari](https://github.com/adguardteam/adguardforsafari) ⭐ 1,173 | 🐛 128 | 🌐 HTML | 📅 2026-03-16 - The most advanced ad blocking extension for Safari
...
* [PiPifier](https://github.com/arnoappenzeller/PiPifier) ⭐ 795 | 🐛 60 | 🌐 Swift | 📅 2021-11-08 - PiPifier is a native macOS 10.12 Safari extension that lets you use every HTML5 video in Picture in Picture mode.
...
* [Ultra TabSaver](https://github.com/Swift-open-source/UltraTabSaver) ⭐ 288 | 🐛 5 | 🌐 Swift | 📅 2020-09-12 - Ultra TabSaver is an open-source Tab Manager for Safari
...
* [nef](https://github.com/bow-swift/nef-plugin) ⭐ 201 | 🐛 1 | 🌐 Swift | 📅 2021-11-11 - This Xcode extension enables you to make a code selection and export it to a snippets. Available on Mac AppStore.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 34,567 | 🐛 153 | 🌐 Rust | 📅 2026-03-16 - zoxide is a smarter cd command for your terminal.
...
* [Quick Look plugins](https://github.com/sindresorhus/quick-look-plugins) ⭐ 18,590 | 🐛 3 | 📅 2026-03-09 - List of useful Quick Look plugins for developers.
...
* [CopyQ](https://github.com/hluk/CopyQ) ⭐ 11,329 | 🐛 414 | 🌐 C++ | 📅 2026-03-16 - Clipboard manager with advanced features
...
* [Clipy](https://github.com/Clipy/Clipy) ⭐ 8,417 | 🐛 261 | 🌐 Swift | 📅 2024-06-29 - Clipy is a Clipboard extension app for macOS.
...
* [dupeGuru](https://github.com/arsenetar/dupeguru/) ⭐ 7,403 | 🐛 515 | 🌐 Python | 📅 2026-01-06 - dupeGuru is a tool to find duplicate files on your computer. It can scan using file names and file contents.
...
* [OpenInTerminal](https://github.com/Ji4n1ng/OpenInTerminal) ⭐ 6,723 | 🐛 40 | 🌐 Swift | 📅 2025-01-18 - Finder Toolbar app for macOS to open the current directory in Terminal, iTerm, Hyper or Alacritty.
...
* [muCommander](https://github.com/mucommander/mucommander) ⭐ 1,190 | 🐛 111 | 🌐 Java | 📅 2026-03-17 - A lightweight, cross-platform file manager with a dual-pane interface.
...
* [Finder Go](https://github.com/onmyway133/FinderGo) ⭐ 1,164 | 🐛 7 | 🌐 Swift | 📅 2023-11-29 - macOS app and Finder Sync Extension to open Terminal, iTerm, Hyper from Finder.
...
* [OpenInCode](https://github.com/sozercan/OpenInCode) ⭐ 908 | 🐛 9 | 🌐 Objective-C | 📅 2022-03-30 - Finder toolbar app to open current folder in Visual Studio Code.
...
* [Duplicate Finder](https://github.com/powerwolf543/DuplicateFinder) ⭐ 157 | 🐛 0 | 🌐 Swift | 📅 2021-08-08 - It's a useful tool that would help you to find all duplicate files which have the same names in the specific folder.
...
* [SaneClick](https://github.com/sane-apps/SaneClick) ⭐ 5 | 🐛 0 | 🌐 Swift | 📅 2026-03-16 - Finder extension with 51+ right-click actions for file management, image conversion, and developer tools.
...
* [OpenEmu](https://github.com/OpenEmu/OpenEmu) ⭐ 17,415 | 🐛 408 | 🌐 Swift | 📅 2025-10-22 - Retro video game emulation for macOS.
...
* [OpenRCT2](https://github.com/OpenRCT2/OpenRCT2) ⭐ 15,296 | 🐛 1,604 | 🌐 C++ | 📅 2026-03-16 - Re-implementation of RollerCoaster Tycoon 2.
...
* [Dolphin](https://github.com/dolphin-emu/dolphin) ⭐ 14,749 | 🐛 417 | 🌐 C++ | 📅 2026-03-16 - Powerful emulator for Nintendo GameCube and Wii games.
...
* [Battle for Wesnoth](https://github.com/wesnoth/wesnoth) ⭐ 6,491 | 🐛 1,462 | 🌐 C++ | 📅 2026-03-16 - Turn-based tactical strategy game, featuring both single-player and online multiplayer combat.
...
* [Sabaki](https://github.com/SabakiHQ/Sabaki) ⭐ 2,656 | 🐛 149 | 🌐 JavaScript | 📅 2026-03-10 - An elegant Go/Baduk/Weiqi board and SGF editor for a more civilized age.
...
* [Widelands](https://github.com/widelands/widelands) ⭐ 2,441 | 🐛 563 | 🌐 C++ | 📅 2026-03-16 - Widelands is a free, open source real-time strategy game with singleplayer campaigns and a multiplayer mode. The game was inspired by Settlers II™ (© Bluebyte) but has significantly more variety and depth to it.
...
* [Stockfish](https://github.com/daylen/stockfish-mac) ⭐ 531 | 🐛 56 | 🌐 C++ | 📅 2024-11-08 - Beautiful, powerful chess application.
...
* [Aseprite](https://github.com/aseprite/aseprite) ⭐ 36,104 | 🐛 1,905 | 🌐 C++ | 📅 2026-03-16 - Animated sprite editor & pixel art tool (Windows, macOS, Linux).
...
* [FreeCAD](https://github.com/FreeCAD/FreeCAD) ⭐ 29,084 | 🐛 3,793 | 🌐 C++ | 📅 2026-03-17 - FreeCAD is an open-source 3D parametric modeler
...
* [Gifski](https://github.com/sindresorhus/Gifski) ⭐ 8,337 | 🐛 15 | 🌐 Swift | 📅 2026-01-07 - Convert videos to high-quality GIFs.
...
* [LibreCAD](https://github.com/LibreCAD/LibreCAD) ⭐ 5,665 | 🐛 686 | 🌐 C++ | 📅 2026-03-16 - LibreCAD is a free Open Source CAD application for Windows, Apple and Linux. Support and documentation are free from our large, dedicated community of users, contributors and developers.
...
* [Gaphor](https://github.com/gaphor/gaphor) ⭐ 2,205 | 🐛 198 | 🌐 Python | 📅 2026-03-16 - Gaphor is the simple modeling tool for UML and SysML.
...
* [Pencil2D Animation](https://github.com/pencil2d/pencil) ⭐ 1,673 | 🐛 198 | 🌐 C++ | 📅 2026-03-13 - Pencil2D is an animation/drawing software for macOS, Windows, and Linux. It lets you create traditional hand-drawn animation (cartoon) using both bitmap and vector graphics.
...
* [macSVG](https://github.com/dsward2/macSVG) ⭐ 1,273 | 🐛 22 | 🌐 Objective-C | 📅 2022-07-17 - macOS application for designing HTML5 SVG (Scalable Vector Graphics) art and animation with a WebKit web view.
...
* [Nugget](https://github.com/cartesiancs/nugget-app) ⭐ 537 | 🐛 2 | 🌐 TypeScript | 📅 2026-02-16 - Video editing software designed for motion effects and versatility.
...
* [Visual Studio Code](https://github.com/Microsoft/vscode) ⭐ 182,749 | 🐛 15,411 | 🌐 TypeScript | 📅 2026-03-17 - Code editor developed by Microsoft.
...
* [Vim](https://github.com/vim/vim) ⭐ 40,018 | 🐛 1,663 | 🌐 Vim Script | 📅 2026-03-16 - ubiquitous text editor
...
* [VSCodium](https://github.com/VSCodium/vscodium) ⭐ 30,533 | 🐛 142 | 🌐 Shell | 📅 2026-03-13 - VSCodium is a community-driven, freely-licensed binary distribution of Microsoft's VS Code with all telemetry removed.
...
* [IntelliJ IDEA Community Edition](https://github.com/JetBrains/intellij-community) ⭐ 19,816 | 🐛 163 | 🌐 Java | 📅 2026-03-17 - IntelliJ IDEA is an integrated development environment written in Java for developing computer software
...
* [ZeroBraneStudio](https://github.com/pkulchenko/ZeroBraneStudio) ⭐ 2,744 | 🐛 111 | 🌐 Lua | 📅 2024-05-19 - ZeroBrane Studio is a lightweight cross-platform Lua IDE with code completion, syntax highlighting, remote debugger, code analyzer, live coding, and debugging support for various Lua engines.
...
* [Flameshot](https://github.com/flameshot-org/flameshot) ⭐ 29,505 | 🐛 655 | 🌐 C++ | 📅 2026-03-14 - Powerful yet simple to use screenshot software.
...
* [Gimp](https://github.com/GNOME/gimp) ⭐ 6,018 | 🐛 0 | 🌐 C | 📅 2026-03-17 - Gimp is GNU Image Manipulation Program.
...
* [ExifCleaner](https://github.com/szTheory/exifcleaner) ⭐ 2,374 | 🐛 72 | 🌐 TypeScript | 📅 2026-02-17 - Remove image metadata with drag and drop, multi-core batch processing, and dark mode.
...
* [InVesalius](https://github.com/invesalius/invesalius3/) ⭐ 770 | 🐛 224 | 🌐 Python | 📅 2026-03-17 - 3D medical imaging reconstruction software
...
* [Katana](https://github.com/bluegill/katana) ⭐ 365 | 🐛 26 | 🌐 JavaScript | 📅 2024-09-06 - Katana is a simple screenshot utility for macOS that lives in your menubar.
...
* [Karabiner-Elements](https://github.com/pqrs-org/Karabiner-Elements) ⭐ 21,722 | 🐛 272 | 🌐 C++ | 📅 2026-03-15 - Karabiner-Elements is a powerful utility for keyboard customization on macOS Sierra (10.12) or later.
...
* [Keycastr](https://github.com/keycastr/keycastr) ⭐ 14,676 | 🐛 93 | 🌐 Objective-C | 📅 2025-12-07 - Keystroke visualizer.
...
* [Unshaky](https://github.com/aahung/Unshaky) ⭐ 3,075 | 🐛 18 | 🌐 Swift | 📅 2023-11-20 - A software attempt to address the "double key press" issue on Apple's butterfly keyboard
...
* [Fluor](https://github.com/Pyroh/Fluor) ⭐ 2,124 | 🐛 47 | 🌐 Swift | 📅 2024-05-31 - Handy tool for macOS allowing you to switch Fn keys' mode based on active application.
...
* [GokuRakuJoudo](https://github.com/yqrashawn/GokuRakuJoudo) ⭐ 1,390 | 🐛 70 | 🌐 Clojure | 📅 2025-08-15 - Karabiner-Elements configuration manager, rescue to bloated karabiner.json
...
* [Mailspring](https://github.com/Foundry376/Mailspring) ⭐ 17,306 | 🐛 19 | 🌐 JavaScript | 📅 2026-03-14 - 💌 A beautiful, fast and maintained fork of @nylas Mail by one of the original authors
...
* [ElectronMail](https://github.com/vladimiry/ElectronMail) ⭐ 1,647 | 🐛 79 | 🌐 TypeScript | 📅 2026-02-18 - Unofficial desktop app for ProtonMail and Tutanota end-to-end encrypted email providers.
...
* [Stats](https://github.com/exelban/stats) ⭐ 37,078 | 🐛 26 | 🌐 Swift | 📅 2026-03-16 - macOS system monitor in your menu bar
...
* [Ice](https://github.com/jordanbaird/Ice) ⭐ 26,590 | 🐛 356 | 🌐 Swift | 📅 2025-09-20 - Powerful menu bar manager for macOS
...
* [xbar](https://github.com/matryer/xbar) ⭐ 18,013 | 🐛 186 | 🌐 Go | 📅 2024-09-10 - Put the output from any script or program into your macOS Menu Bar.
...
* [Hidden Bar](https://github.com/dwarvesf/hidden) ⭐ 13,548 | 🐛 144 | 🌐 Swift | 📅 2026-03-03 - An ultra-light MacOS utility that helps hide menu bar icons
...
* [eul](https://github.com/gao-sun/eul) ⭐ 9,818 | 🐛 71 | 🌐 Swift | 📅 2024-05-25 - macOS status monitoring app written in SwiftUI.
...
* [Dozer](https://github.com/Mortennn/Dozer) ⭐ 8,616 | 🐛 92 | 🌐 Swift | 📅 2023-11-30 - Hide MacOS menubar items.
...
* [AnyBar](https://github.com/tonsky/AnyBar) ⭐ 6,037 | 🐛 17 | 🌐 Objective-C | 📅 2025-09-04 - macOS menubar status indicator.
...
* [OnlySwitch](https://github.com/jacklandrin/OnlySwitch) ⭐ 5,545 | 🐛 55 | 🌐 Swift | 📅 2026-02-06 - All-in-One status bar button, hide MacBook Pro's notch, dark mode, AirPods, Shortcuts
...
* [MeetingBar](https://github.com/leits/MeetingBar) ⭐ 5,162 | 🐛 106 | 🌐 Swift | 📅 2026-03-04 - Menu bar app for your calendar meetings
...
* [Itsycal](https://github.com/sfsam/Itsycal) ⭐ 3,839 | 🐛 80 | 🌐 Objective-C | 📅 2026-03-13 - A tiny calendar for that lives in the Mac menu bar.
...
* [SwiftBar](https://github.com/swiftbar/SwiftBar) ⭐ 3,806 | 🐛 24 | 🌐 Swift | 📅 2026-02-07 - Powerful macOS menu bar customization tool.
...
* [MenuMeters](https://github.com/yujitach/MenuMeters) ⭐ 3,062 | 🐛 103 | 🌐 Objective-C | 📅 2024-05-20 - CPU, memory, disk, and network monitoring tools for macOS.
...
* [MiniSim](https://github.com/okwasniewski/MiniSim) ⭐ 2,364 | 🐛 13 | 🌐 Swift | 📅 2026-02-27 - MacOS menu bar app for launching iOS  and Android 🤖 emulators.
...
* [Pika](https://github.com/superhighfives/pika) ⭐ 2,354 | 🐛 14 | 🌐 Swift | 📅 2026-03-17 - Is an easy to use, open-source, native colour picker for macOS.
...
* [SensibleSideButtons](https://github.com/archagon/sensible-side-buttons) ⭐ 2,067 | 🐛 53 | 🌐 C | 📅 2024-02-17 - Small menu bar utility that lets you use your third-party mouse's side buttons for navigation across a variety of apps.
...
* [LinkLiar](https://github.com/halo/LinkLiar) ⭐ 1,459 | 🐛 1 | 🌐 Swift | 📅 2025-08-05 - Keep your MAC address random for privacy (intuitive GUI for ifconfig)
...
* [Shifty](https://github.com/thompsonate/Shifty) ⭐ 1,288 | 🐛 34 | 🌐 Swift | 📅 2022-09-04 - macOS menu bar app that gives you more control over Night Shift.
...
* [gSwitch](https://github.com/CodySchrank/gSwitch) ⭐ 919 | 🐛 17 | 🌐 Swift | 📅 2021-03-29 - macOS status bar app that allows control over the gpu on dual gpu macbooks.
...
* [TimeScribe](https://github.com/WINBIGFOX/timescribe) ⭐ 763 | 🐛 13 | 🌐 PHP | 📅 2026-03-15 - Simple and free working time recording.
...
* [DatWeatherDoe](https://github.com/inderdhir/DatWeatherDoe) ⭐ 532 | 🐛 3 | 🌐 Swift | 📅 2026-03-06 - Simple menu bar weather app for macOS written in Swift.
...
* [SlimHUD - Cyanocitta](https://github.com/AlexPerathoner/SlimHUD) ⭐ 462 | 🐛 21 | 🌐 Swift | 📅 2025-07-27 - Replacement for MacOS' volume, brightness and keyboard backlight HUDs.
...
* [RustCast](https://github.com/unsecretised/rustcast) ⭐ 441 | 🐛 6 | 🌐 Rust | 📅 2026-03-16 - Blazingly fast, customisable multi tool, application launcher
...
* [Pareto Security](https://github.com/paretoSecurity/pareto-mac/) ⭐ 430 | 🐛 10 | 🌐 Swift | 📅 2026-03-13 - A MenuBar app to automatically audit your Mac for basic security hygiene.
...
* [BarTranslate](https://github.com/ThijmenDam/BarTranslate) ⭐ 228 | 🐛 15 | 🌐 Swift | 📅 2026-03-06 - A handy menu bar translator app that supports DeepL and Google Translate.
...
* [SaneBar](https://github.com/sane-apps/SaneBar) ⭐ 202 | 🐛 5 | 🌐 Swift | 📅 2026-03-17 - Privacy-first menu bar manager with Touch ID lock, Always-Hidden Zone, and automation triggers.
...
* [Grayscale Mode](https://github.com/rkbhochalya/grayscale-mode) ⭐ 109 | 🐛 4 | 🌐 Swift | 📅 2021-09-01 - Manage grayscale mode from menu bar.
...
* [Monitor Bar](https://github.com/tidiemme/monitorbar) ⭐ 75 | 🐛 1 | 🌐 Swift | 📅 2023-12-19 - Monitor Bar app supports three modes, compact, normal, extra. It monitors battery, Disk, Memory, CPU, Network bandwidth, Wi-Fi.
...
* [Quickeys](https://github.com/alexrosenfeld10/Quickeys) ⭐ 74 | 🐛 1 | 🌐 Swift | 📅 2020-11-28 - A mac menu bar app that provides note taking functionality though a quick dropdown menu.
...
* [DisplayMenu](https://github.com/Kwpolska/DisplayMenu) ⭐ 48 | 🐛 0 | 🌐 Swift | 📅 2019-04-03 - Simple (bare-bones) macOS menubar extra to apply display presets.
...
* [VPN Bypass](https://github.com/GeiserX/VPN-Bypass) ⭐ 43 | 🐛 0 | 🌐 Swift | 📅 2026-03-10 - Route specific domains and services around your corporate VPN while keeping the rest of your traffic protected.

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift

  **Website:** <https://github.com/GeiserX/VPN-Bypass> ⭐ 43 | 🐛 0 | 🌐 Swift | 📅 2026-03-10
...
* [ScreenHint](https://github.com/salemhilal/ScreenHint) ⭐ 17 | 🐛 0 | 🌐 Swift | 📅 2024-05-15 - A simple screenshotting utility for thinking clearly.
...
* [spicetify-cli](https://github.com/spicetify/spicetify-cli) ⭐ 22,430 | 🐛 14 | 🌐 JavaScript | 📅 2026-03-14 - Command-line tool to customize the official Spotify client. Supports Windows, MacOS and Linux.
...
* [YouTube-Music](https://github.com/steve228uk/YouTube-Music) ⭐ 2,806 | 🐛 109 | 🌐 Swift | 📅 2023-11-14 - macOS wrapper for music.youtube.com.
...
* [Spotify-Cli-Mac](https://github.com/ersel/spotify-cli-mac) ⭐ 188 | 🐛 12 | 🌐 JavaScript | 📅 2022-12-07 - Control Spotify without leaving your terminal. :notes:
...
* [Carol](https://github.com/AnaghSharma/Carol) ⭐ 131 | 🐛 1 | 🌐 Swift | 📅 2025-04-27 - A minimal and beautiful lyrics app that stays in the menu bar of macOS.
...
* [iTunes Graphs](https://github.com/Zac-Garby/iTunes-Graphs) ⭐ 55 | 🐛 0 | 🌐 Swift | 📅 2018-05-03 - macOS app to visualise your iTunes library as graphs.
...
* [NetNewsWire](https://github.com/Ranchero-Software/NetNewsWire) ⭐ 9,820 | 🐛 865 | 🌐 Swift | 📅 2026-03-16 - Feed reader for macOS.
...
* [Vienna](https://github.com/ViennaRSS/vienna-rss) ⭐ 1,959 | 🐛 70 | 🌐 Objective-C | 📅 2026-03-16 - Vienna is a RSS/Atom newsreader for macOS.
...
* [hacker-menu](https://github.com/owenthereal/hacker-menu) ⭐ 1,007 | 🐛 10 | 🌐 JavaScript | 📅 2018-10-10 - Hacker News Delivered to Desktop.
...
* [joplin](https://github.com/laurent22/joplin) ⭐ 53,933 | 🐛 596 | 🌐 TypeScript | 📅 2026-03-17 - Note taking and to-do application with synchronization capabilities for Windows, macOS, Linux, Android and iOS.
...
* [Boostnote](https://github.com/BoostIO/BoostNote-Legacy) ⭐ 16,969 | 🐛 510 | 🌐 JavaScript | 📅 2023-04-19 - Note-taking application made for programmers just like you.
...
* [FSNotes](https://github.com/glushchenko/fsnotes) ⭐ 7,273 | 🐛 6 | 🌐 Swift | 📅 2026-03-15 - Notes manager for macOS/iOS: modern notational velocity (nvALT) on steroids.
...
* [Standard Notes](https://github.com/standardnotes/app) ⭐ 6,354 | 🐛 89 | 🌐 TypeScript | 📅 2026-03-06 - Safe place for your notes, thoughts, and life's work.
...
* [Dnote](https://github.com/dnote/dnote) ⭐ 3,017 | 🐛 40 | 🌐 Go | 📅 2026-03-05 - A simple command line notebook with multi-device sync and web interface.
...
* [Simplenote](https://github.com/Automattic/simplenote-macos) ⭐ 1,540 | 🐛 178 | 🌐 Swift | 📅 2026-03-03 - Simplest way to keep notes.
...
* [Jupyter Notebook Viewer](https://github.com/tuxu/nbviewer-app) ⭐ 778 | 🐛 9 | 🌐 Swift | 📅 2023-12-15 - Notebook viewer for macOS.
...
* [Stik](https://github.com/0xMassi/stik_app) ⭐ 150 | 🐛 4 | 🌐 TypeScript | 📅 2026-03-13 - Instant thought capture for macOS. Global hotkey summons a post-it note, type and close. Notes stored as plain markdown files.
...
* [Reactotron](https://github.com/infinitered/reactotron) ⭐ 15,523 | 🐛 154 | 🌐 TypeScript | 📅 2025-10-13 - Desktop app for inspecting your React JS and React Native projects. macOS, Linux, and Windows.
...
* [React Native Debugger](https://github.com/jhen0409/react-native-debugger) ⭐ 10,476 | 🐛 181 | 🌐 JavaScript | 📅 2023-10-21 - Desktop app for inspecting your React Native projects. macOS, Linux, and Windows.
...
* [Lepton](https://github.com/hackjutsu/Lepton) ⭐ 10,329 | 🐛 85 | 🌐 JavaScript | 📅 2025-11-18 - Democratizing Code Snippets Management (macOS/Win/Linux).
...
* [ImageOptim](https://github.com/ImageOptim/ImageOptim) ⭐ 9,750 | 🐛 196 | 🌐 HTML | 📅 2023-10-29 - GUI image optimizer for Mac.
...
* [Numi](https://github.com/nikolaeu/numi) ⭐ 6,372 | 🐛 134 | 🌐 JavaScript | 📅 2026-02-20 - Beautiful calculator app for macOS
...
* [SwiftyBeaver](https://github.com/SwiftyBeaver/SwiftyBeaver) ⭐ 6,068 | 🐛 9 | 🌐 Swift | 📅 2024-11-26 - Convenient logging during development & release in Swift.
...
* [Shuttle](https://github.com/fitztrev/shuttle) ⭐ 4,595 | 🐛 41 | 🌐 Objective-C | 📅 2021-12-22 - Simple SSH shortcut menu for macOS.
...
* [Gas Mask](https://github.com/2ndalpha/gasmask) ⭐ 3,821 | 🐛 86 | 🌐 Objective-C | 📅 2026-03-01 - Hosts file manager for macOS.
...
* [syncthing-macosx](https://github.com/syncthing/syncthing-macos) ⭐ 3,533 | 🐛 42 | 🌐 Objective-C | 📅 2026-03-15 - Frugal nativemacOS macOS Syncthing application bundle.
...
* [Platypus](https://github.com/sveinbjornt/Platypus) ⭐ 3,360 | 🐛 35 | 🌐 Objective-C | 📅 2026-02-25 - Mac developer tool that creates application bundles from command line scripts.
...
* [Betaflight Configurator](https://github.com/betaflight/betaflight-configurator) ⭐ 3,087 | 🐛 54 | 🌐 JavaScript | 📅 2026-03-16 - Cross platform configuration tool for the Betaflight firmware.
...
* [Gramps](https://github.com/gramps-project/gramps) ⭐ 2,846 | 🐛 66 | 🌐 Python | 📅 2026-03-16 - A genealogy program that is both intuitive for hobbyists and feature-complete for professional genealogists.
...
* [Vagrant Manager](https://github.com/lanayotech/vagrant-manager) ⭐ 1,864 | 🐛 20 | 🌐 Objective-C | 📅 2020-05-31 - Manage your vagrant machines in one place with Vagrant Manager for macOS.
...
* [Hosts](https://github.com/specialunderwear/Hosts.prefpane) ⭐ 1,639 | 🐛 10 | 🌐 Objective-C | 📅 2020-09-25 - Cocoa GUI for /etc/hosts.
...
* [Unused](https://github.com/jeffhodnett/Unused) ⭐ 1,372 | 🐛 9 | 🌐 Objective-C | 📅 2018-06-19 - Mac app for checking Xcode projects for unused resources.
...
* [ChipMunk](https://github.com/esrlabs/chipmunk) ⭐ 704 | 🐛 151 | 🌐 TypeScript | 📅 2026-03-16 - Log analysis tool.
...
* [DevDocs for macOS](https://github.com/dteoh/devdocs-macos) ⭐ 481 | 🐛 3 | 🌐 Swift | 📅 2023-03-04 - An unofficial DevDocs API documentation viewer.
...
* [IINA](https://github.com/iina/iina) ⭐ 44,092 | 🐛 1,965 | 🌐 Swift | 📅 2026-03-11 - The modern video player for macOS.
...
* [MacMorpheus](https://github.com/emoRaivis/MacMorpheus) ⭐ 298 | 🐛 19 | 🌐 Objective-C | 📅 2017-03-24 - 3D 180/360 video player for macOS for PSVR with head tracking.
...
* [mkchromecast](https://github.com/muammar/mkchromecast) ⭐ 2,334 | 🐛 216 | 🌐 Python | 📅 2025-12-21 - Cast macOS and Linux Audio/Video to your Google Cast and Sonos Devices.
...
* [gPodder](https://github.com/gpodder/gpodder) ⭐ 1,426 | 🐛 348 | 🌐 Python | 📅 2026-03-07 - gPodder is a simple, open source podcast client.
...
* [Doughnut](https://github.com/dyerc/Doughnut) ⭐ 240 | 🐛 30 | 🌐 Swift | 📅 2023-01-02 - Podcast player and library for mac
...
* [Ice](https://github.com/jordanbaird/Ice) ⭐ 26,590 | 🐛 356 | 🌐 Swift | 📅 2025-09-20 - Ice is a versatile menu bar manager that goes beyond hiding and showing items to offer a rich set of productivity features.
...
* [Maccy](https://github.com/p0deje/Maccy) ⭐ 18,970 | 🐛 149 | 🌐 Swift | 📅 2026-02-10 - Lightweight search-as-you-type clipboard manager.
...
* [Readest](https://github.com/readest/readest) ⭐ 18,748 | 🐛 118 | 🌐 TypeScript | 📅 2026-03-17 - Readest is a modern, feature-rich ebook reader designed for avid readers.
...
* [Super Productivity](https://github.com/johannesjo/super-productivity) ⭐ 18,002 | 🐛 849 | 🌐 TypeScript | 📅 2026-03-16 - Free to do list & time tracker for programmers & designers with Jira integration.
...
* [Screenpipe](https://github.com/screenpipe/screenpipe) ⭐ 17,243 | 🐛 98 | 🌐 Rust | 📅 2026-03-17 - 24/7 screen and audio recording with AI-powered search. Local-first, privacy-focused rewind alternative.
...
* [ActivityWatch](https://github.com/ActivityWatch/activitywatch) ⭐ 16,978 | 🐛 179 | 🌐 Python | 📅 2026-02-23 - Open-source automated time tracker that tracks how you spend time on your devices.
...
* [Xournal++](https://github.com/xournalpp/xournalpp/) ⭐ 14,489 | 🐛 1,177 | 🌐 C++ | 📅 2026-03-15 - Take handwritten notes with ease
...
* [espanso](https://github.com/espanso/espanso) ⭐ 13,396 | 🐛 492 | 🌐 Rust | 📅 2026-03-15 - Cross-platform Text Expander, a powerful replacement for Alfred Snippets
...
* [Cerebro](https://github.com/cerebroapp/cerebro) ⭐ 8,538 | 🐛 75 | 🌐 JavaScript | 📅 2026-02-22 - Cross-platform launcher app.
...
* [stretchly](https://github.com/hovancik/stretchly) ⭐ 6,053 | 🐛 98 | 🌐 JavaScript | 📅 2026-03-16 - Cross-platform electron app that reminds you to take breaks when working with computer.
...
* [Manta](https://github.com/hql287/Manta) ⭐ 5,436 | 🐛 135 | 🌐 JavaScript | 📅 2025-02-02 - Flexible invoicing desktop app with beautiful & customizable templates.
...
* [Ueli](https://github.com/oliverschwendener/ueli) ⭐ 4,476 | 🐛 68 | 🌐 TypeScript | 📅 2026-03-16 - A keystroke launcher for macOS (and Windows) like Spotlight or Alfred.
...
* [SelfControl](https://github.com/SelfControlApp/selfcontrol) ⭐ 4,317 | 🐛 302 | 🌐 Objective-C | 📅 2025-12-29 - macOS app to block your own access to distracting websites etc for a predetermined period of time. It can not be undone by the app or by a restart – you must wait for the timer to run out.
...
* [TomatoBar](https://github.com/ivoronin/TomatoBar) ⭐ 3,198 | 🐛 40 | 🌐 Swift | 📅 2026-02-19 - Pomodoro Technique Timer for macOS with Touch Bar support.
...
* [Quicksilver](https://github.com/quicksilver/Quicksilver) ⭐ 2,870 | 🐛 74 | 🌐 Objective-C | 📅 2026-03-14 - Quicksilver is a fast macOS productivity application that gives you the power to control your Mac quickly and elegantly.
...
* [Timer](https://github.com/michaelvillar/timer-app) ⭐ 2,680 | 🐛 2 | 🌐 Swift | 📅 2026-02-07 - Simple Timer app for Mac.
...
* [Ao](https://github.com/klaudiosinani/ao) ⭐ 2,184 | 🐛 119 | 🌐 JavaScript | 📅 2025-11-03 - Elegant Microsoft To-Do desktop app.
...
* [far2l](https://github.com/elfmz/far2l) ⭐ 2,132 | 🐛 446 | 🌐 C++ | 📅 2026-03-16 - Linux/Mac fork of FAR Manager v2
...
* [ControlPlane](https://github.com/dustinrue/ControlPlane) ⭐ 1,783 | 🐛 122 | 🌐 Objective-C | 📅 2023-07-07 - Automate running tasks based on where you are or what you do.
...
* [DropPoint](https://github.com/GameGodS3/DropPoint) ⭐ 1,081 | 🐛 28 | 🌐 CSS | 📅 2023-07-31 - Make drag-and-drop easier using DropPoint. Helps to drag content without having to open side-by-side windows.
...
* [Freeter](https://github.com/FreeterApp/Freeter) ⭐ 945 | 🐛 12 | 🌐 TypeScript | 📅 2025-09-18 - App that allows you to gather everything you need for work in one place, organized by projects and workflows, and have a quick access to them.
...
* [ClipMenu](https://github.com/naotaka/ClipMenu) ⭐ 929 | 🐛 35 | 🌐 Objective-C | 📅 2020-08-02 - Clipboard manager for macOS.
...
* [Kiwix](https://github.com/kiwix/apple) ⭐ 693 | 🐛 34 | 🌐 Swift | 📅 2026-03-16 - Kiwix for iOS and macOS, build on Swift.
...
* [Thyme](https://github.com/joaomoreno/thyme) ⭐ 584 | 🐛 15 | 🌐 Objective-C | 📅 2020-01-31 - The task timer for OS X.
...
* [Yippy](https://github.com/mattDavo/Yippy) ⭐ 389 | 🐛 43 | 🌐 Swift | 📅 2024-02-13 - macOS open source clipboard manager
...
* [PDF Archiver](https://github.com/PDF-Archiver/PDF-Archiver) ⭐ 328 | 🐛 9 | 🌐 Swift | 📅 2026-03-16 - Nice tool for tagging and archiving tasks.
...
* [Dockit](https://github.com/xicheng148/Dockit) ⭐ 255 | 🐛 5 | 🌐 Swift | 📅 2025-10-28 - An application that can dock any window to the edge of the screen.
...
* [Blink Eye](https://github.com/nomandhoni-cs/blink-eye) ⭐ 242 | 🐛 15 | 🌐 TypeScript | 📅 2026-03-06 - An Open-Source minimalist Eye Care reminder & Break Timer app for Windows, macOS, and Linux.
...
* [macOrganizer](https://github.com/shubhambatra3019/macOrganizer) ⭐ 125 | 🐛 0 | 🌐 Swift | 📅 2018-10-31 - macOS app for organizing files or removing unnecessary files.
...
* [status-bar-todo](https://github.com/Onix-Systems/osx-status-bar-todo) ⭐ 124 | 🐛 7 | 🌐 Swift | 📅 2023-08-11 - Simple macOS app to keep TODO-list in status bar.
...
* [SaneClip](https://github.com/sane-apps/SaneClip) ⭐ 10 | 🐛 1 | 🌐 Swift | 📅 2026-03-16 - Clipboard manager with Touch ID protection, AES-256-GCM encryption, and sensitive data detection.
...
* [File Architect](https://github.com/filearchitect/app) ⭐ 5 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-10 - Create file and folder structures from plain text descriptions.
...
* [SaneSales](https://github.com/sane-apps/SaneSales) ⭐ 0 | 🐛 1 | 🌐 Swift | 📅 2026-03-16 - Universal indie sales tracker for LemonSqueezy, Gumroad, and Stripe with on-device privacy.
...
* [Aerial](https://github.com/JohnCoates/Aerial) ⭐ 20,951 | 🐛 66 | 🌐 Swift | 📅 2025-08-12 - Apple TV Aerial Screensaver for macOS.
...
* [Brooklyn](https://github.com/pedrommcarrasco/Brooklyn) ⭐ 5,625 | 🐛 29 | 🌐 Swift | 📅 2024-10-09 - Screensaver inspired by Apple's Event on October 30, 2018.
...
* [Cryptomator](https://github.com/cryptomator/cryptomator) ⭐ 14,785 | 🐛 288 | 🌐 Java | 📅 2026-03-16 - Multi-platform transparent client-side encryption of your files in the cloud.
...
* [LuLu](https://github.com/objective-see/LuLu) ⭐ 12,152 | 🐛 478 | 🌐 Objective-C | 📅 2026-03-15 - LuLu is macOS firewall application that aims to block unauthorized (outgoing) network traffic.
...
* [VeraCrypt](https://github.com/veracrypt/VeraCrypt) ⭐ 9,341 | 🐛 509 | 🌐 C | 📅 2025-09-30 - Disk encryption with strong security based on TrueCrypt.
...
* [Swifty](https://github.com/swiftyapp/swifty) ⭐ 946 | 🐛 94 | 🌐 JavaScript | 📅 2026-01-23 - Free and offline password manager.
...
* [Cloaker](https://github.com/spieglt/cloaker) ⭐ 428 | 🐛 2 | 🌐 Rust | 📅 2023-05-05 - simple drag-and-drop, password-based file encryption.
...
* [macOS GateKeeper Helper](https://github.com/wynioux/macOS-GateKeeper-Helper) ⭐ 266 | 🐛 0 | 🌐 Shell | 📅 2020-07-16 - Simple macOS GateKeeper script. It helps you to control your GateKeeper.
...
* [SaneHosts](https://github.com/sane-apps/SaneHosts) ⭐ 7 | 🐛 0 | 🌐 Swift | 📅 2026-03-16 - System-level ad and tracker blocker via /etc/hosts with 200+ curated blocklists and Touch ID protection.
...
* [qBittorrent](https://github.com/qbittorrent/qBittorrent) ⭐ 36,023 | 🐛 2,513 | 🌐 C++ | 📅 2026-03-16 - BitTorrent client in Qt.
...
* [Transmission](https://github.com/transmission/transmission) ⭐ 14,468 | 🐛 761 | 🌐 C++ | 📅 2026-03-11 - Official Transmission BitTorrent client repository.
...
* [Tribler](https://github.com/Tribler/tribler) ⭐ 5,204 | 🐛 84 | 🌐 Python | 📅 2026-03-16 - Privacy enhanced BitTorrent client with P2P content discovery.
...
* [Cyberduck](https://github.com/iterate-ch/cyberduck) ⭐ 4,314 | 🐛 504 | 🌐 Java | 📅 2026-03-16 - Cyberduck is a libre server and cloud storage browser for Mac and Windows with support for FTP, SFTP, WebDAV, Amazon S3, OpenStack Swift, Backblaze B2, Microsoft Azure & OneDrive, Google Drive and Dropbox.
...
* [Deluge](https://github.com/deluge-torrent/deluge) ⭐ 1,741 | 🐛 32 | 🌐 Python | 📅 2026-03-07 - Lightweight cross-platform BitTorrent client.
...
* [NitroShare](https://github.com/nitroshare/nitroshare-desktop) ⭐ 1,656 | 🐛 138 | 🌐 C++ | 📅 2025-07-12 - Transferring files from one device to another
...
* [mac2imgur](https://github.com/mileswd/mac2imgur) ⭐ 957 | 🐛 23 | 🌐 Swift | 📅 2019-02-16 - Simple Mac app designed to make uploading images and screenshots to Imgur quick and effortless.
...
* [Soduto](https://github.com/soduto/Soduto) ⭐ 422 | 🐛 21 | 🌐 Swift | 📅 2026-02-27 - Soduto is a KDEConnect compatible application for macOS. It gives AirDrop like integration and allows file and clipboard sharing between your phones, desktops and tablets.
...
* [Caprine](https://github.com/sindresorhus/caprine#features) ⭐ 7,340 | 🐛 277 | 🌐 TypeScript | 📅 2026-01-02 - Elegant Facebook Messenger desktop app.
...
* [RedditOS](https://github.com/Dimillian/RedditOS) ⭐ 4,025 | 🐛 20 | 🌐 Swift | 📅 2023-10-23 - A SwiftUI Reddit client for macOS.
...
* [Goofy](https://github.com/danielbuechele/goofy) ⭐ 978 | 🐛 4 | 🌐 Swift | 📅 2026-02-28 - Unofficial Facebook Messenger client.
...
* [OBS Studio](https://github.com/obsproject/obs-studio) ⭐ 70,984 | 🐛 1,072 | 🌐 C | 📅 2026-03-17 - Free and open source software for live streaming and screen recording.
...
* [Sloth](https://github.com/sveinbjornt/Sloth) ⭐ 8,846 | 🐛 3 | 🌐 Objective-C | 📅 2025-11-16 - Sloth is an macOS application that displays a list of all open files and sockets in use by all running applications on your system.
...
* [KeepingYouAwake](https://github.com/newmarcel/KeepingYouAwake) ⭐ 6,353 | 🐛 36 | 🌐 Objective-C | 📅 2025-10-30 - Prevents your Mac from going to sleep.
...
* [Latest](https://github.com/mangerlahn/Latest) ⭐ 4,489 | 🐛 140 | 🌐 Swift | 📅 2026-02-09 - Small utility app for macOS that makes sure you know about all the latest updates to the apps you use.
...
* [HoRNDIS](https://github.com/jwise/HoRNDIS) ⭐ 3,270 | 🐛 100 | 🌐 C++ | 📅 2023-02-05 - Android USB tethering driver for macOS.
...
* [Turbo Boost Switcher](https://github.com/rugarciap/Turbo-Boost-Switcher) ⭐ 1,524 | 🐛 48 | 🌐 Objective-C | 📅 2025-09-27 - Turbo Boost Switcher is a little application for Mac computers that allows to enable and/or disable the Turbo Boost feature.
...
* [ProfileCreator](https://github.com/ProfileCreator/ProfileCreator) ⭐ 1,475 | 🐛 76 | 🌐 Swift | 📅 2025-01-11 - macOS Application to create standard or customized configuration profiles.
...
* [Fanny](https://github.com/DanielStormApps/Fanny) ⭐ 1,363 | 🐛 37 | 🌐 Swift | 📅 2020-05-02 - Monitor your Mac's fan speed and CPU temperature from your Notification Center.
...
* [AppPolice](https://github.com/AppPolice/AppPolice) ⭐ 1,138 | 🐛 34 | 🌐 Objective-C | 📅 2023-09-06 - App for macOS with a minimalistic UI which lets you quickly throttle down the CPU usage of any running process.
...
* [Loading](https://github.com/BonzaiThePenguin/Loading) ⭐ 620 | 🐛 8 | 🌐 Objective-C | 📅 2020-11-17 - Simple network activity monitor for macOS.
...
* [Diagnostics](https://github.com/macmade/Diagnostics) ⭐ 211 | 🐛 1 | 🌐 Swift | 📅 2021-08-02 - Diagnostics is an application displaying the diagnostic reports from applications on macOS.
...
* [Tabby](https://github.com/Eugeny/tabby) ⭐ 69,580 | 🐛 2,612 | 🌐 TypeScript | 📅 2026-02-28 - Powerful cross-platform terminal emulator, featuring a modern GUI, and offering SSH, serial, Telnet, and SCP client support.
...
* [Alacritty](https://github.com/alacritty/alacritty) ⭐ 62,992 | 🐛 337 | 🌐 Rust | 📅 2026-03-15 - Cross-platform, GPU-accelerated terminal emulator.
...
* [Hyper](https://github.com/vercel/hyper) ⭐ 44,717 | 🐛 1,026 | 🌐 TypeScript | 📅 2024-08-14 - Terminal built on web technologies.
...
* [Kitty](https://github.com/kovidgoyal/kitty) ⭐ 31,880 | 🐛 11 | 🌐 Python | 📅 2026-03-17 - Cross-platform, fast, feature full, GPU based terminal emulator.
...
* [iTerm 2](https://github.com/gnachman/iTerm2) ⭐ 17,194 | 🐛 54 | 🌐 Objective-C | 📅 2026-03-17 - Terminal emulator for macOS that does amazing things.
...
* [wallpapper](https://github.com/mczachurski/wallpapper) ⭐ 3,410 | 🐛 20 | 🌐 Swift | 📅 2025-01-01 - wallpapper is a console application for creating dynamic wallpapers for Mojave.
...
* [Console](https://github.com/macmade/Console) ⭐ 425 | 🐛 2 | 🌐 Swift | 📅 2021-08-02 - macOS console application.
...
* [Pock](https://github.com/pock/pock) ⭐ 10,137 | 🐛 70 | 🌐 Swift | 📅 2022-11-12 - Display macOS Dock in Touch Bar.
...
* [MyTouchbarMyRules](https://github.com/toxblh/MTMR) ⭐ 4,285 | 🐛 204 | 🌐 Swift | 📅 2026-03-12 - App to customize your Touch Bar as you want.
...
* [NVM](https://github.com/nvm-sh/nvm) ⭐ 92,345 | 🐛 386 | 🌐 Shell | 📅 2026-03-13 - Node Version Manager.
...
* [Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF) ⭐ 75,377 | 🐛 437 | 🌐 TypeScript | 📅 2026-03-16 - Locally hosted web application that allows you to perform various operations on PDF files
...
* [PowerShell](https://github.com/powershell/powershell) ⭐ 51,891 | 🐛 1,414 | 🌐 C# | 📅 2026-03-16 - PowerShell is a cross-platform automation and configuration tool/framework that works well with your existing tools.
...
* [Balena Etcher](https://github.com/balena-io/etcher) ⭐ 33,320 | 🐛 654 | 🌐 TypeScript | 📅 2025-07-29 - Flash OS images to SD cards & USB drives, safely and easily.
...
* [KeePassXC](https://github.com/keepassxreboot/keepassxc) ⭐ 26,253 | 🐛 830 | 🌐 C++ | 📅 2026-03-15 - Cross-platform community-driven port of the Windows application "Keepass Password Safe"
...
* [calibre](https://github.com/kovidgoyal/calibre) ⭐ 24,396 | 🐛 7 | 🌐 Python | 📅 2026-03-16 - cross platform e-book manager.
...
* [homebrew-cask](https://github.com/Homebrew/homebrew-cask) ⭐ 21,897 | 🐛 25 | 🌐 Ruby | 📅 2026-03-17 - A CLI workflow for the administration of macOS applications distributed as binaries
...
* [Mos](https://github.com/Caldis/Mos) ⭐ 19,294 | 🐛 332 | 🌐 Swift | 📅 2026-03-16 - Smooth your mouse's scrolling and reverse the mouse scroll direction
...
* [Kap](https://github.com/wulkano/kap) ⭐ 19,135 | 🐛 247 | 🌐 TypeScript | 📅 2024-11-12 - Screen recorder application built with web technology.
...
* [OpenCore Legacy Patcher](https://github.com/dortania/OpenCore-Legacy-Patcher) ⭐ 16,919 | 🐛 25 | 🌐 Python | 📅 2025-12-30 - OpenCore Legacy Patcher is a tool for installing new MacOS versions on legacy macs.
...
* [nix-package-manager](https://github.com/NixOS/nix) ⭐ 16,339 | 🐛 3,960 | 🌐 C++ | 📅 2026-03-17 - Nix is a reproducible package manager alternative to Homebrew, with over 80,000 packages.
...
* [KeeWeb](https://github.com/keeweb/keeweb) ⭐ 12,899 | 🐛 430 | 🌐 HTML | 📅 2025-05-19 - Cross-platform password manager compatible with KeePass.
...
* [Nmap](https://github.com/nmap/nmap) ⭐ 12,565 | 🐛 915 | 🌐 C | 📅 2026-03-17 - Nmap - the Network Mapper.
...
* [Wireshark](https://github.com/wireshark/wireshark) ⭐ 9,075 | 🐛 2 | 🌐 C | 📅 2026-03-17 - Wireshark is the world’s foremost and widely-used network protocol analyzer. It lets you see what’s happening on your network at a microscopic level and is the de facto (and often de jure) standard across many commercial and non-profit enterprises, government agencies, and educational institutions.
...
* [PeaZip](https://github.com/peazip/PeaZip) ⭐ 7,036 | 🐛 16 | 🌐 Pascal | 📅 2026-02-12 - Free file archiver utility and open source file compression and encryption tool supporting 200+ formats.
...
* [MacPass](https://github.com/MacPass/MacPass) ⭐ 6,836 | 🐛 292 | 🌐 Objective-C | 📅 2025-05-07 - Native macOS KeePass client.
...
* [Keka](https://github.com/aonez/Keka) ⭐ 6,502 | 🐛 249 | 🌐 PHP | 📅 2026-03-12 - Keka is a full featured file archiver, as easy as it can be.
...
* [Lunar](https://github.com/alin23/lunar) ⭐ 5,468 | 🐛 5 | 🌐 Swift | 📅 2026-03-13 - Intelligent adaptive brightness for your external displays.
...
* [Android tool for Mac](https://github.com/mortenjust/androidtool-mac) ⭐ 5,425 | 🐛 67 | 🌐 Swift | 📅 2023-03-16 - One-click screenshots, video recordings, app installation for iOS and Android
...
* [Flying Carpet](https://github.com/spieglt/flyingcarpet) ⭐ 5,001 | 🐛 19 | 🌐 Rust | 📅 2026-03-08 - cross-platform file transfer over ad-hoc wifi, like AirDrop but for Mac/Windows/Linux.
...
* [Übersicht](https://github.com/felixhageloh/uebersicht) ⭐ 4,896 | 🐛 169 | 🌐 Objective-C | 📅 2025-06-28 - Keep an eye on what's happening on your machine and in the world.
...
* [fselect](https://github.com/jhspetersson/fselect) ⭐ 4,405 | 🐛 13 | 🌐 Rust | 📅 2026-03-16 - Command-line tool to search files with SQL syntax.
...
* [ScreenCat](https://github.com/maxogden/screencat) ⭐ 3,011 | 🐛 37 | 🌐 CSS | 📅 2016-02-18 - ScreenCat is a screen sharing + remote collaboration application.
...
* [BeardedSpice](https://github.com/beardedspice/beardedspice) ⭐ 2,843 | 🐛 401 | 🌐 Objective-C | 📅 2021-05-12 - Control web based media players with the media keys found on Mac keyboards.
...
* [TRex](https://github.com/amebalabs/TRex) ⭐ 1,753 | 🐛 4 | 🌐 Swift | 📅 2026-02-13 - TRex is the easiest way to copy the uncopyable text from images, YouTube videos, Zoom calls and more. If you can see it - you can copy it. TRex captures any text right into your Clipboard with magic of OCR.
...
* [OpenRocket](https://github.com/openrocket/openrocket) ⭐ 1,742 | 🐛 286 | 🌐 Java | 📅 2026-03-14 - OpenRocket is a cross-platform utility tool to model and simulate model rockets and their flight characteristics.
...
* [Gray](https://github.com/zenangst/Gray) ⭐ 1,426 | 🐛 21 | 🌐 Swift | 📅 2022-07-22 - Pick between the light appearance and the dark appearance on a per-app basis with the click of a button
...
* [Telephone](https://github.com/64characters/Telephone) ⭐ 1,144 | 🐛 129 | 🌐 Swift | 📅 2026-03-10 - SIP softphone for macOS.
...
* [Monolingual](https://github.com/IngmarStein/Monolingual) ⭐ 563 | 🐛 41 | 🌐 Swift | 📅 2026-03-02 - Remove unnecessary language resources from macOS
...
* [PB for Desktop](https://github.com/sidneys/pb-for-desktop) ⭐ 517 | 🐛 40 | 🌐 JavaScript | 📅 2023-01-06 - Receive native push notifications on macOS, Windows and Linux.
...
* [MacPacker](https://github.com/sarensw/MacPacker/) ⭐ 394 | 🐛 6 | 🌐 Swift | 📅 2026-03-11 - Archive manager for macOS. Preview (nested) archives without extracting them. Extract single files.
...
* [CoreLocationCLI](https://github.com/fulldecent/corelocationcli) ⭐ 264 | 🐛 1 | 🌐 Swift | 📅 2026-03-16 - Get the physical location of your device and prints it to standard output
...
* [MiddleDrag](https://github.com/NullPointerDepressiveDisorder/MiddleDrag) ⭐ 135 | 🐛 12 | 🌐 Swift | 📅 2026-03-06 - Three-finger trackpad gestures for middle-click and middle-drag.
...
* [Kyapchar](https://github.com/vishaltelangre/Kyapchar) ⭐ 70 | 🐛 1 | 🌐 Swift | 📅 2018-07-11 - Simple screen and microphone audio recorder for macOS.
...
* [ShadowsocksX-NG](https://github.com/shadowsocks/ShadowsocksX-NG) ⭐ 32,908 | 🐛 314 | 🌐 Swift | 📅 2024-10-29 - Next Generation of ShadowsocksX.
...
* [Tunnelblick](https://github.com/Tunnelblick/Tunnelblick) ⭐ 3,180 | 🐛 64 | 🌐 Objective-C | 📅 2026-01-28 - Tunnelblick is a graphic user interface for OpenVPN on macOS.
...
* [HandBrake](https://github.com/HandBrake/HandBrake) ⭐ 22,671 | 🐛 275 | 🌐 C | 📅 2026-03-16 - HandBrake is a video transcoder available for Linux, Mac, and Windows.
...
* [VLC](https://github.com/videolan/vlc) ⭐ 17,864 | 🐛 3 | 🌐 C | 📅 2026-03-17 -  VLC is a free and open source cross-platform multimedia player
...
* [WebTorrent Desktop](https://github.com/webtorrent/webtorrent-desktop) ⭐ 10,042 | 🐛 76 | 🌐 JavaScript | 📅 2026-03-13 - Streaming torrent app. For Mac, Windows, and Linux.
...
* [OpenShot](https://github.com/OpenShot/openshot-qt) ⭐ 5,542 | 🐛 360 | 🌐 Python | 📅 2026-03-16 - Easy to use, quick to learn, and surprisingly powerful video editor.
...
* [QuickLook Video](https://github.com/Marginal/QLVideo) ⭐ 3,334 | 🐛 10 | 🌐 Swift | 📅 2026-03-13 - This package allows macOS Finder to display thumbnails, static QuickLook previews, cover art and metadata for most types of video files.
...
* [Datamosh](https://github.com/maelswarm/Datamosh) ⭐ 111 | 🐛 0 | 🌐 Swift | 📅 2017-08-29 - Datamosh your videos on macOS.
...
* [GNU Gatekeeper](https://github.com/willamowius/gnugk) ⭐ 86 | 🐛 0 | 🌐 C++ | 📅 2026-03-16 - Video conferencing server for H.323 terminals.
...
* [Equinox](https://github.com/rlxone/Equinox) ⭐ 1,855 | 🐛 14 | 🌐 Swift | 📅 2026-03-04 - Equinox is an application that allows you to create macOS dynamic wallpapers.
...
* [Artify](https://github.com/NghiaTranUIT/artify-macos) ⭐ 180 | 🐛 8 | 🌐 Swift | 📅 2019-03-02 - A macOS application for bringing dedicatedly 18th century Arts to everyone
...
* [BingPaper](https://github.com/pengsrc/BingPaper) ⭐ 171 | 🐛 7 | 🌐 Swift | 📅 2020-05-18 - Use Bing daily photo as your wallpaper on macOS.
...
* [Rectangle](https://github.com/rxhanson/Rectangle) ⭐ 28,599 | 🐛 102 | 🌐 Swift | 📅 2026-02-25 - Rectangle is a window manager heavily based on Spectacle, written in Swift.
...
* [Yabai](https://github.com/koekeishiya/yabai) ⭐ 28,416 | 🐛 267 | 🌐 C | 📅 2026-02-26 - A tiling window manager for macOS based on binary space partitioning.
...
* [Amethyst](https://github.com/ianyh/Amethyst) ⭐ 16,035 | 🐛 317 | 🌐 Swift | 📅 2026-03-17 - Automatic tiling window manager for macOS.
...
* [AltTab](https://github.com/lwouis/alt-tab-macos) ⭐ 15,114 | 🐛 53 | 🌐 Swift | 📅 2026-03-15 - AltTab brings the power of Windows alt-tab to macOS.
...
* [AltTab](https://github.com/lwouis/alt-tab-macos) ⭐ 15,114 | 🐛 53 | 🌐 Swift | 📅 2026-03-15 - Switch between open applications on macOS with a Windows-like Alt+Tab experience.
...
* [Hammerspoon](https://github.com/Hammerspoon/hammerspoon) ⭐ 15,003 | 🐛 658 | 🌐 Objective-C | 📅 2026-02-26 - Staggeringly powerful macOS desktop automation with Lua.
...
* [Loop](https://github.com/MrKai77/Loop) ⭐ 10,219 | 🐛 46 | 🌐 Swift | 📅 2026-03-12 - Window management made elegant.
...
* [ShiftIt](https://github.com/fikovnik/ShiftIt) ⭐ 5,550 | 🐛 165 | 🌐 Objective-C | 📅 2023-11-20 - Managing windows size and position.
...
* [Phoenix](https://github.com/kasper/phoenix) ⭐ 4,525 | 🐛 50 | 🌐 Objective-C | 📅 2025-08-31 - Lightweight macOS window and app manager scriptable with JavaScript.
...
* [Window Glue](https://github.com/Conxt/WindowGlue) ⭐ 217 | 🐛 0 | 🌐 Swift | 📅 2025-07-09 - A simple macOS menu bar utility that lets you glue two windows together so that they behave (mostly) as one.
